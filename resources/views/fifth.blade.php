...
<head>
    ...
    <style id="pagestyle" type="text/css">
        ...
        *.u_1423168301 {
            background-image: url('../assets/images/WhatsApp Image 2023-12-27 at 6.42.52 PM.jpeg') !important;
            background-color: rgb(236, 236, 236) !important;
            background-position: 50% 50% !important;
            background-size: cover !important;
            background-repeat: no-repeat !important;
                                                                ...
                                                                <div class="dmRespRow u_1074424685"
                                                                    ...
                                                                    <div class="dmRespColsWrapper" id="1643366786">
                                                                        <div class="u_1008450588 dmRespCol small-12 large-8 medium-8"
                                                                            id="1008450588">
                                                                            <h3 class="u_1381619377 dmNewParagraph"
                                                                                id="1381619377"
                                                                                data-element-type="paragraph">24/7
                                                                                Accident Tow Service</h3>
                                                                            <div class="u_1043941571 dmNewParagraph"
                                                                                id="1043941571"
                                                                                style="display: block;">
                                                                                <div><span style=""
                                                                                        class="font-size-20 lh-1">At
                                                                                        RMK Towing, we understand that
                                                                                        accidents can be overwhelming
                                                                                        and often occur unexpectedly.
                                                                                        That's why our 24/7 Accident Tow
                                                                                        service is dedicated to
                                                                                        providing immediate and
                                                                                        professional assistance to
                                                                                        drivers involved in collisions
                                                                                        or accidents.</span></div>
                                                                                <div>
                                                                                    <ul class="innerList defaultList">
                                                                                        <li><span style=""
                                                                                                class="font-size-20 lh-1">Immediate
                                                                                                Response</span></li>
                                                                                        <li><span style=""
                                                                                                class="font-size-20 lh-1">Safe
                                                                                                Handling and
                                                                                                Towing</span>
                                                                                        </li>
                                                                                        <li><span style=""
                                                                                                class="font-size-20 lh-1">Efficient
                                                                                                Scene Clearance</span>
                                                                                        </li>
                                                                                        <li><span style=""
                                                                                                class="font-size-20 lh-1">Compassionate
                                                                                                Service</span>
                                                                                        </li>
                                                                                        <li><span style=""
                                                                        ...
                                                                        <div class="u_1679317891 dmRespCol small-12 large-4 medium-4"
                                                                            ...
                                                                            <div class="u_1651871966 imageWidget align-center"
                                                                                ...
                                                                                id="1651871966"><img
                                                                                    src="{{ asset('assets/images/WhatsApp Image 2023-12-27 at 6.42.47 PM.jpeg') }}"
                                                                                    id="1750159344" class=""
